...
alias dotfiles.wiki_restart='dotfiles.wiki_stop; dotfiles.wiki_reload_daemon; dotfiles.wiki_start'
alias dotfiles.wiki_files='find -L ~/neuron -type f -name "*md"'
alias dotfiles.wiki_watch='find -L ~/neuron -type f -name "*md" | entr -s wiki.brainstorm'
