...
globalkeys = gears.table.join(
  ...
  end, { description = "lance vscode", group = "tag-client" }),
  -- }}}
  ...
  awful.key({ modkey }, "b", function()
    ...
    { description = "ouvre le navigateur", group = "tag-client" }),
...
clientkeys = gears.table.join(
  awful.key({ modkey, }, "f",
    ...
    { description = "toggle fullscreen", group = "client-size" }),
  ...
  awful.key({ modkey, }, "m",
    ...
    { description = "(un)maximize", group = "client-size" })
