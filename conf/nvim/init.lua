...
local config = {
	...
	mappings = {
		...
		n = {
			...
			["<leader>vn"] = {
				"<cmd>vsplit ~/.dotfiles/conf/nvim/init.lua<cr>",
				desc = "Édite la configuration de vim",
			},
			["<leader>vic"] = {
				"vsplit ~/.dotfiles/install.conf.yaml<cr>",
				desc = "Édite le script de chargement des .dotfiles",
			},
			["<leader>vz"] = {
